...
import { lightTheme, darkTheme, LightMpaStyle, DarkMapStyleWithoutLandmarks } from "./Theme"
...
export class Store
{
	...
	@observable maptype : any = this.themeType == ThemeType.LIGHT? LightMpaStyle : DarkMapStyleWithoutLandmarks
