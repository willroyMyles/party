...
const Account = () => {
  ...
  useEffect(() => setdarkTheme(tm.themeType == ThemeType.DARK), []);
      ...
      <View>
        ...
        <View marginT-20 row spread paddingH-10>
          ...
          <Switch
            ...
            onValueChange={handleLocationChanged}></Switch>
        </View>
        {tm.isLocationGranted && (
          <View marginT-20 row spread paddingH-10>
            ...
            <TouchableOpacity
              onPress={() => {
                Alert.alert(
                  'Additional Location Permission Needed',
                  `     \tHey, we need additional persmission location to be "allow all the time" to determine when your at a party. this will check if your at a party periodically. No personal information will be collected in the process`,
                  [
                    {
                      text: 'Maybe Later',
                      onPress: () => {},
